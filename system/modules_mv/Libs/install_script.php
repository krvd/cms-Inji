...
return function ($step = NULL, $params = array()) {
    Inji::app()->db->create_table('libs_asseter_front_libs', array(
        'lafl_id' => 'pk',
    ...
    Inji::app()->db->create_table('libs_asseter_front_lib_files', array(
        'laflf_id' => 'pk',
    ...
    //jQuery
    $jQueryId = Inji::app()->db->insert('libs_asseter_front_libs', array(
        'lafl_name' => 'jQuery',
        'lafl_version' => '1.11.2',
        'lafl_required' => '',
        'lafl_enabled' => '1',
    ));
    Inji::app()->db->insert('libs_asseter_front_lib_files', array(
        'laflf_lafl_id' => $jQueryId,
        'laflf_file' => 'libs/jquery/jquery-1.11.2.min.js',
        'laflf_type' => 'js',
    ));
    //Bootstrap
    $bootstrapId = Inji::app()->db->insert('libs_asseter_front_libs', array(
        'lafl_name' => 'Bootstrap',
        'lafl_version' => '3.3.4',
    ...
    //Font-awesome
    $fontAwesomeId = Inji::app()->db->insert('libs_asseter_front_libs', array(
    ...
    //bxslider
    $id = Inji::app()->db->insert('libs_asseter_front_libs', array(
        'lafl_name' => 'bxslider',
        'lafl_version' => '4.2.3',
        'lafl_required' => $jQueryId,
        'lafl_enabled' => '0',
