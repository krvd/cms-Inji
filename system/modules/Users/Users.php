...
class Users extends Module
{
    ...
    function init()
    {
        ...
        if (isset($_POST['autorization']) && trim(filter_input(INPUT_POST, 'user_login')) && filter_input(INPUT_POST, 'user_pass')) {
            unset($_POST['autorization']);
            return $this->autorization(trim(filter_input(INPUT_POST, 'user_login')), filter_input(INPUT_POST, 'user_pass'), strpos(filter_input(INPUT_POST, 'user_login'), '@') ? 'mail' : 'login', false);
        }
